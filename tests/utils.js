...
exports.errors = {
    ...
    MINT_DATE_LOWER: '"MINT_DATE_IS_LOWER_THAN_NOW"',
    MINT_AMOUNT_LOWER: '"MINT_AMOUNT_MUST_BE_GREATER_THAN_ZERO"',
    MINT_RATE_LOWER: '"MINT_RATE_MUST_BE_GREATER_THAN_ZERO"',
    NO_DOUBLE_MINTING: '"TOKEN_ID_ALREADY_MINTED"',
    NEW_MINTER_EXIST: '"NEW_MINTER_EXISTS"',
    OLD_MINTER_NOT_EXIST: '"OLD_MINTER_DOES_NOT_EXIST"',
    TOKEN_FROZEN: '"TOKEN_FROZEN"',
    TOKEN_NOT_FROZEN: '"TOKEN_NOT_FROZEN"',
    INTER_TRANSFER_PAUSED: '"INTER_TRANSFER_PAUSED"',
    INTER_TRANSFER_NOT_PAUSED: '"INTER_TRANSFER_NOT_PAUSED"',
    INTER_TRANSFER_AFTER_EXPIRY_PAUSED: '"INTER_TRANSFER_AFTER_EXPIRY_PAUSED"',
    INTER_TRANSFER_AFTER_EXPIRY_NOT_PAUSED: '"INTER_TRANSFER_AFTER_EXPIRY_NOT_PAUSED"',
    NO_INTER_TRANSFER_AFTER_EXPIRY: '"NO_INTER_TRANSFER_AFTER_EXPIRY"',
    BURN_AMOUNT_LOWER: '"BURN_AMOUNT_MUST_BE_GREATER_THAN_ZERO"',
    NO_INTER_TRANSFER: '"NO_INTER_TRANSFER"',
    NO_INTER_TRANSFER_AFTER_EXPIRY: '"NO_INTER_TRANSFER_AFTER_EXPIRY"'
};
